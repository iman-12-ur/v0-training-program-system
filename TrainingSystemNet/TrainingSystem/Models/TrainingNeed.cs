...
namespace TrainingSystem.Models
{
    ...
    public enum TrainingNeedStatus
    {
        ...
        // حالة اعتماد الاحتياج (سير العمل: رئيس القسم ← مدير الدائرة ← دائرة التدريب)
    ...
    public class TrainingNeed
    {
        ...
        public List<WorkflowStage> GetWorkflowStages()
        {
            ...
            {
                ("إنشاء طلب الاحتياج", "رئيس القسم"),
                ("التحقق من اكتمال البيانات", "النظام"),
                ("حساب الفجوة والأولوية تلقائياً", "النظام"),
                ("مراجعة واعتماد / رفض / طلب تعديل", "مدير الدائرة"),
                ...
                ("تقييم أثر التدريب", "الموظف / رئيس القسم"),
